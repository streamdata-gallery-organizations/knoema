...
- name: Knoema API Dimension Group
  ...
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/knoema-logo.jpg
  humanURL: https://knoema.com
  baseURL: http://knoema.com//api/1.0//meta/group/{groupKey}
  tags: Groups,Dimensions
  properties:
  - type: x-openapi-spec
...
- name: Knoema API List of tags
  x-api-slug: knoema-api
  description: Lists out all the public tags present in the system
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/knoema-logo.jpg
  humanURL: https://knoema.com
  baseURL: http://knoema.com//api/1.0//frontend/tags
  tags: Tags
  properties:
  - type: x-openapi-spec
...
- name: Knoema API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/knoema/master/_listings/knoema/openapi.md
x-common:
